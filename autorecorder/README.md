...
Currently configured for **AWS Strands (TypeScript) + React** — the 26 routes of
...
Videos land in `videos/` as `STRANDS-TS-react-<NN>-<name>.webm`, 1920×1080, ~25fps
...
every demo at `<route>/demo-chat`. This app tracks 29 doc routes; the 3 that carry no
