 ...
 *
 * The catalog id has to agree in three places or nothing paints:
 * `a2ui/catalog.ts` here, the `createSurface(...)` call in
 * `backend/src/agents/a2ui-fixed-agent.ts`, and the schema's component names
 * against `a2ui/definitions.ts`.
 */
export default function Page() {
  return (
    <DemoFrame
      parentPath="/generative-ui/a2ui/fixed-schema"
      subtitle={`agent: ${AGENT_ID} · catalog: copilotkit://flight-fixed-catalog`}
    >
      <CopilotKit
