 ...
 *
 * The Voice page passes `enableInspector={false}` outright, and explains why in
 * a comment: the dev-only inspector overlay intercepts pointer events on top of
 * its sample-audio button. That page's published value wins over this one.
 */
