...
If you only need file uploads (audio, images, video, documents), use [Multimodal Attachments](/strands-typescript/multimodal-attachments) instead. Voice is specifically about live transcription of recorded speech into chat input.
