...
[Headless Threads](/strands-typescript/headless-threads)). Thread **rename** is one of those headless
...
- [Headless Threads](/strands-typescript/headless-threads): build a custom UI with the `useThreads` data layer
- [Threads Drawer reference (React)](/reference/components/CopilotThreadsDrawer)
- [CopilotChat](/strands-typescript/prebuilt-components/chat): the chat the drawer connects to
