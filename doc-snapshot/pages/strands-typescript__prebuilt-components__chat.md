...
For a collapsible docked chat, use [CopilotSidebar](/strands-typescript/prebuilt-components/sidebar).
For a floating bubble that overlays content, use [CopilotPopup](/strands-typescript/prebuilt-components/popup).
For saved conversations and switching between prior conversations, drop in the [Threads Drawer](/strands-typescript/prebuilt-components/copilot-threads-drawer) (or go headless with [Headless Threads](/strands-typescript/headless-threads)).
...
| `messageView` | Slot for the message list — see [slots](/strands-typescript/custom-look-and-feel/slots). |
...
- **CSS variables / class overrides** — see [CSS customization](/strands-typescript/custom-look-and-feel/css)
- **Slots (subcomponents)** — see [slots](/strands-typescript/custom-look-and-feel/slots)
- **Fully headless** — see [headless UI](/strands-typescript/custom-look-and-feel/headless-ui)
