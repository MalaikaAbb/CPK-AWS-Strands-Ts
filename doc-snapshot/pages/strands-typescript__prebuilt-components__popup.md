...
use [CopilotSidebar](/strands-typescript/prebuilt-components/sidebar). For a fully embedded
chat pane, use [`<CopilotChat>`](/strands-typescript/prebuilt-components/chat) directly.
...
| `header` | Slot for the popup header bar — see the [slot system](/strands-typescript/custom-look-and-feel/slots). |
...
[custom look and feel](/strands-typescript/custom-look-and-feel/slots) for the full slot
reference.
