...
<!-- setup skipped: agent-context-setup is not bundled for strands-typescript -->
...
**[shared state](/strands-typescript/shared-state)** instead.

## Related

- **[Shared State (overview)](/strands-typescript/shared-state)** — bidirectional
  reads + writes.
