...
- **Thread architecture:** [Threads & Persistence Architecture](/strands-typescript/premium/threads-explained) — event replay model and WebSocket sync
- **Production self-hosting:** [Self-host CopilotKit Intelligence](/strands-typescript/premium/self-hosting) — run the Threads platform inside your infrastructure with CopilotKit Engineering
