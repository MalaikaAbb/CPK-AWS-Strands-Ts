...
- [CopilotPopup](/strands-typescript/prebuilt-components/popup) and [CopilotSidebar](/strands-typescript/prebuilt-components/sidebar): the prebuilt surfaces that own modal state.
...
- [Slots](/strands-typescript/custom-look-and-feel/slots): the `messageView` / `assistantMessage` slot system used above.
- [Programmatic Control](/strands-typescript/programmatic-control): driving agent runs from code without a chat UI.
